      ...
      <div class="flex flex-col lg:flex-row justify-between gap-8 lg:gap-12">
        ...
        >
          ...
          <div class="flex space-x-4">
            <!-- LinkedIn -->
            <a href="https://www.linkedin.com/company/conecta-florestas/" target="_blank" rel="noopener noreferrer" class="text-gray-300 hover:text-white transition-all duration-200 hover:scale-110">
