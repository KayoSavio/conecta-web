<template>
  <section class="relative bg-gradient-to-br from-primary to-secondary text-white section-padding">
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="space-y-8">
          <div class="space-y-4">
            <h1 class="text-4xl md:text-6xl font-bold leading-tight animate-fade-in">
              <!-- TODO: Substituir pelo headline oficial da CONECTA -->
              Conecte seu negócio ao futuro
            </h1>
            <p class="text-xl md:text-2xl text-white/90 animate-slide-up">
              <!-- TODO: Substituir pelo subtítulo oficial -->
              Soluções inovadoras que transformam empresas e impulsionam resultados
            </p>
          </div>
          ...
          <div class="flex flex-col sm:flex-row gap-4 animate-slide-up">
            ...
            <button 
              ...
              class="btn-outline text-lg px-8 py-4 border-white text-white hover:bg-white hover:text-primary"
            >
              Solicitar Orçamento
            </button>
          </div>
        ...
        <div class="flex justify-center lg:justify-end">
          <div class="relative w-full max-w-md">
            <!-- TODO: Substituir pela imagem/ilustração oficial da CONECTA -->
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center">
              ...
              <p class="text-white/80">Imagem/Ilustração da CONECTA</p>
            </div>
          </div>
        </div>
      </div>
