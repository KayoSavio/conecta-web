<template>
  <section id="inicio" class="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
    ...
    <div class="relative z-20 container-custom px-4 sm:px-8 lg:px-12 pt-20 sm:pt-24 lg:pt-32">
      <div class="max-w-7xl mx-auto">
        <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div class="space-y-8 text-white">
            ...
            >
              ...
              <button 
                @click="scrollToForm"
                class="group w-full relative overflow-hidden border-2 border-white text-white hover:text-primary font-bold px-8 py-4 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-xl"
              >
            ...
            <div class="p-4 sm:p-0 py-0 flex items-center gap-4 mt-6">
              ...
              >
                <svg class="w-5 h-5 text-white group-hover:text-green-400 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="glassmorphism-card relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl hover:shadow-3xl transition-all duration-700 hover:scale-105 overflow-hidden animate-glassmorphism">
                  ...
                  <div class="relative z-10 space-y-8">
                    ...
                    <div class="space-y-4">
                      ...
                      <div class="flex items-center gap-4 text-white/95 hover:text-white transition-colors duration-300 group">
                        <div class="flex-shrink-0 w-10 h-10 bg-emerald-500/20 rounded-xl flex items-center justify-center group-hover:bg-emerald-500/30 transition-all duration-300 group-hover:scale-110">
        ...
        <div class="w-full flex justify-center items-center">
          <div class="flex flex-col items-center justify-center gap-6 lg:hidden flex my-6 max-w-[200px]">
          <p class="text-white">Parceiros</p>
            <svg width="full" viewBox="0 0 145 34" xmlns="http://www.w3.org/2000/svg" class="grayscale hover:grayscale-0 hover:opacity-100 opacity-60 logo-desk logo-sicredi gtag-click-trigger fill-current text-white" data-gtag-action="logo" data-gtag-label="logo">
            ...
            <div class="text-center">
              <img src="/src/assets/images/incubadora.png" alt="INCUBADORA Instituto Federal" class="w-full grayscale hover:grayscale-0 hover:opacity-100 opacity-60 object-contain mb-2" />
            </div>

            <div class="text-center">
              <img src="/src/assets/images/cftaLogo.png" alt="CFTA Conselho Federal" class="w-full grayscale hover:grayscale-0 hover:opacity-100 opacity-60 object-contain mb-2" />
            </div>


            <div class="text-center">
              <img src="/src/assets/images/cresci.png" alt="CRECI-ES" class="w-full grayscale hover:grayscale-0 hover:opacity-100 opacity-60 object-contain mb-2" />
            </div>
        </div>
        </div>
      </div>
    ...
    <div class="absolute bottom-0 flex flex-col justify-center items-center overflow-x-auto space-x-4 scrollbar-hide hidden lg:flex">
            ...
            <div class="flex gap-6">
              ...
              <div class="text-center">
                <img src="/src/assets/images/incubadora.png" alt="INCUBADORA Instituto Federal" class="w-full h-12 object-contain grayscale hover:grayscale-0 hover:opacity-100 opacity-60 mb-2" />
              </div>

              <div class="text-center">
                <img src="/src/assets/images/cftaLogo.png" alt="CFTA Conselho Federal" class="w-full h-8 object-contain grayscale hover:grayscale-0 hover:opacity-100 opacity-60 mb-2" />
              </div>

              <div class="text-center">
                <img src="/src/assets/images/cresci.png" alt="CRECI-ES" class="w-full h-12 object-contain grayscale hover:grayscale-0 hover:opacity-100 opacity-60 mb-2" />
              </div>
            </div>
        </div>
  </section>
