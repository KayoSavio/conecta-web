<template>
  <section id="para-quem" class="section-padding bg-gray-50">
...
onMounted(() => {
  ...
  const cards = document.querySelectorAll('.who-we-serve-card')
  cards.forEach(card => {
